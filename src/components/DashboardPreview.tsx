...
export default function DashboardPreview() {
  ...
  return (
    <section id="demo" className="py-24 relative bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-12">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight">
            Veja a inteligência do <span className="gradient-text">LocalizeAI em Ação</span>
          </h2>
        ...
        <div className="max-w-5xl mx-auto glass-panel rounded-2xl border border-slate-800 shadow-2xl overflow-hidden">
          {/* Top Control Bar */}
          <div className="p-4 sm:p-6 bg-slate-900/90 border-b border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
            {/* Category Tabs */}
            <div className="flex items-center gap-2 p-1 bg-slate-950/80 rounded-xl border border-slate-800/80 w-full sm:w-auto">
              <button
                ...
                className={`flex-1 sm:flex-initial px-4 py-2 rounded-lg text-xs sm:text-sm font-semibold transition-all flex items-center justify-center gap-2 ${
                  activeCategory === "ads"
            ...
            <button
              ...
              className="p-2 rounded-lg bg-slate-800/80 hover:bg-slate-700 text-slate-300 transition-colors border border-slate-700/60 self-end sm:self-auto"
          ...
          {/* Interactive Body */}
          <div className="p-6 bg-slate-950/90 space-y-6">
            {/* Input Box Summary */}
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 space-y-2">
              ...
              <p className="text-sm font-medium text-slate-200 bg-slate-950 p-3 rounded-lg border border-slate-800">
                {activeCategory === "ads" &&
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* USA Card */}
              <div className="p-5 rounded-xl bg-slate-900/60 border border-slate-800 space-y-3 relative group">
                ...
                <span className="inline-block text-[10px] text-cyan-400 font-medium">
              ...
              <div className="p-5 rounded-xl bg-slate-900/60 border border-slate-800 space-y-3 relative group">
                ...
                <span className="inline-block text-[10px] text-indigo-400 font-medium">
              ...
              {/* Action Banner */}
              <div className="p-5 rounded-xl bg-gradient-to-br from-indigo-950/80 to-slate-900 border border-indigo-500/30 flex flex-col justify-between space-y-4">
                ...
                <a
                  href="/dashboard"
                  className="w-full py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs text-center transition-colors flex items-center justify-center gap-1.5"
                >
